...
class AboutUs extends Component{
	...
	componentDidMount() {
    	document.title = 'Movie Review | About';
	}
					...
					<div className="page">
						...
						<div className="row">
							<div className="col-md-4">
								<figure><img src={require('../dummy/figure.jpg')} alt="figure image" /></figure>
							</div>
						...
						<div className="row">
							...
							<div className="col-md-3">
								<div className="team">
									<figure className="team-image"><img src={require('../dummy/person-1.jpg')} alt="" /></figure>
							...
							<div className="col-md-3">
								<div className="team">
									<figure className="team-image"><img src={require('../dummy/person-2.jpg')} alt="" /></figure>
							...
							<div className="col-md-3">
								<div className="team">
									<figure className="team-image"><img src={require('../dummy/person-3.jpg')} alt="" /></figure>
							...
							<div className="col-md-3">
								<div className="team">
									<figure className="team-image"><img src={require('../dummy/person-4.jpg')} alt="" /></figure>
									<h2 className="team-name">Sarah Stuart</h2>
